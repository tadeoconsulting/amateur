...
| 4 | **¿Cómo se resuelven los empates en eliminación directa?** | **Resuelta:** tiempo extra y, si sigue, penales (ver [007](007-fixture-eliminacion-copa-relampago.md), propuesta) | [007](007-fixture-eliminacion-copa-relampago.md) |
| 5 | **¿Sorteo o el orden de inscripción?** ¿Ida y vuelta? | Orden de inscripción, una sola vuelta | [003](003-fixture.md) |
| 6 | **¿Qué es "Copa" y qué es "Relámpago"?** | **Resuelta:** Copa = grupos + eliminación; Relámpago = eliminación en un día (ver [007](007-fixture-eliminacion-copa-relampago.md), propuesta) | [007](007-fixture-eliminacion-copa-relampago.md) |
...
1. **Fixture de eliminación directa, copa y relámpago.** *Especificación escrita, pendiente de confirmar decisiones menores:* [007](007-fixture-eliminacion-copa-relampago.md). Resuelve las decisiones 4 y 6.
