...
const navItems = [
  ...
  },
  {
    ...
    icon: (active: boolean) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <rect x="3" y="4" width="18" height="16" rx="2" stroke="currentColor" strokeWidth="1.5" fill={active ? "currentColor" : "none"} />
        <path d="M3 9h18M9 4v16" stroke={active ? "var(--color-surface-primary)" : "currentColor"} strokeWidth="1.5" />
      </svg>
    ),
  },
  {
    ...
    icon: (active: boolean) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <rect x="3" y="13" width="4" height="8" rx="1" stroke="currentColor" strokeWidth="1.5" fill={active ? "currentColor" : "none"} />
        <rect x="10" y="8" width="4" height="13" rx="1" stroke="currentColor" strokeWidth="1.5" fill={active ? "currentColor" : "none"} />
        <rect x="17" y="3" width="4" height="18" rx="1" stroke="currentColor" strokeWidth="1.5" fill={active ? "currentColor" : "none"} />
      </svg>
    ),
  },
  {
